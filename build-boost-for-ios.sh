...
#: ${BOOST_LIBS:="coroutine random regex graph chrono thread signals filesystem system date_time"}
#: ${BOOST_LIBS:="random regex chrono thread filesystem system locale"}
: ${BOOST_LIBS:="regex chrono thread system locale"}
